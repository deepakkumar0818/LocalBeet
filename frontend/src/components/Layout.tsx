...
const navigation = [
  ...
  { name: 'Ingredient Master', href: '/raw-materials', icon: Package },
  { name: 'Recipes (BOM)', href: '/bill-of-materials', icon: FileText },
  ...
  { 
    ...
    hasDropdown: true,
    children: [
      { name: 'Inventory', href: '/downtown-restaurant', icon: Layers },
      { name: 'Sales Orders', href: '/downtown-restaurant/sales-orders', icon: ShoppingCart },
    ]
  },
  { 
    name: 'Marina Walk Cafe', 
    icon: Coffee, 
    hasDropdown: true,
    children: [
      { name: 'Inventory', href: '/marina-walk-cafe', icon: Layers },
      { name: 'Sales Orders', href: '/marina-walk-cafe/sales-orders', icon: ShoppingCart },
    ]
  },
  { 
    ...
    hasDropdown: true,
    children: [
      { name: 'Inventory', href: '/mall-food-court', icon: Layers },
      { name: 'Sales Orders', href: '/mall-food-court/sales-orders', icon: ShoppingCart },
    ]
  },
  { 
    ...
    hasDropdown: true,
    children: [
      { name: 'Inventory', href: '/drive-thru-express', icon: Layers },
      { name: 'Sales Orders', href: '/drive-thru-express/sales-orders', icon: ShoppingCart },
    ]
  },
  { name: 'Warehouse Master', href: '/warehouse-master', icon: Warehouse },
