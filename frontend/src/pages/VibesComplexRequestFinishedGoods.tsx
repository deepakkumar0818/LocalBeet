...
const VibesComplexRequestFinishedGoods: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        navigate('/marina-walk-cafe/finished-goods')
      } else {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            onClick={() => navigate('/marina-walk-cafe/finished-goods')}
      ...
      <div className="card p-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            <button type="button" onClick={() => navigate('/marina-walk-cafe/finished-goods')} className="btn-secondary flex items-center">
...
export default VibesComplexRequestFinishedGoods
