...
const TaibaHospitalRequestRawMaterials: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        navigate('/drive-thru-express/raw-materials')
      } else {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            onClick={() => navigate('/drive-thru-express/raw-materials')}
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-gray-900">Raw Materials ({rawMaterials.length} available)</h3>
                ...
                {formData.items.map((item, index) => (
                  <div key={index} className="grid grid-cols-7 gap-3 p-4 border border-gray-200 rounded-lg bg-blue-50">
                    <div>
                      ...
                      <select className="input-field text-sm" value={item.materialCode} onChange={(e) => handleMaterialCodeChange(index, e.target.value)}>
                    ...
                    <div>
                      ...
                      <input type="text" className="input-field text-sm bg-gray-100" value={item.materialName} placeholder="Material Name" readOnly />
                    </div>
                    <div>
          ...
          <div className="flex justify-end space-x-4 pt-6 border-t">
            <button type="button" onClick={() => navigate('/drive-thru-express/raw-materials')} className="btn-secondary flex items-center">
...
export default TaibaHospitalRequestRawMaterials
