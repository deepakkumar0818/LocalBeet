...
const DowntownRestaurant: React.FC = () => {
  ...
  const loadOutletData = async () => {
    try {
      ...
      // Get Downtown Restaurant outlet
      ...
      if (outletsResponse.success) {
        ...
        if (downtownRestaurant) {
          ...
          setError('Downtown Restaurant not found')
        }
      } else {
  ...
  const loadInventory = async (outletId?: string) => {
    ...
    try {
      ...
      if (rawMaterialsResponse.success) {
        console.log('Loaded Downtown Restaurant Raw Materials Inventory:', rawMaterialsResponse.data)
  ...
  const downloadSampleCSV = () => {
    const sampleData = [
      ...
      ['Finished Good', 'FG-001', 'Caesar Salad', 'Salads', 'PORTION', '8.50', '25', '25', '5', '50', '212.50', 'In Stock', 'Downtown Restaurant', '2024-01-15', 'Fresh daily']
    ]
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Downtown Restaurant...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Downtown Restaurant</h1>
            <p className="text-gray-600">Premium dining restaurant - {outlet?.outletName}</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Premium Dining Restaurant</p>
          ...
          <div className="text-right">
            <div className="text-2xl font-bold text-blue-600">{outlet?.outletCode}</div>
              ...
              <div className="relative">
                <Package className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
                 <input
                   type="text"
                   placeholder={
                     'Search materials and products by name, code, or category...'
                   }
