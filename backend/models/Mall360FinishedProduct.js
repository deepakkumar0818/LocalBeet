...
const Mall360FinishedProductSchema = new mongoose.Schema({
...
Mall360FinishedProductSchema.index({ productCode: 1 });
Mall360FinishedProductSchema.index({ productName: 1 });
Mall360FinishedProductSchema.index({ category: 1 });
Mall360FinishedProductSchema.index({ status: 1 });

// Add pagination plugin
Mall360FinishedProductSchema.plugin(mongoosePaginate);

module.exports = (connection) => connection.model('Mall360FinishedProduct', Mall360FinishedProductSchema);
