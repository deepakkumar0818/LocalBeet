...
const KuwaitCityRawMaterialSchema = new mongoose.Schema({
...
KuwaitCityRawMaterialSchema.index({ materialCode: 1 });
KuwaitCityRawMaterialSchema.index({ materialName: 1 });
KuwaitCityRawMaterialSchema.index({ category: 1 });
KuwaitCityRawMaterialSchema.index({ status: 1 });

// Add pagination plugin
KuwaitCityRawMaterialSchema.plugin(mongoosePaginate);

module.exports = (connection) => connection.model('KuwaitCityRawMaterial', KuwaitCityRawMaterialSchema);
