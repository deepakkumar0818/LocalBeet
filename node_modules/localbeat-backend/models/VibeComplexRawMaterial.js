...
const VibeComplexRawMaterialSchema = new mongoose.Schema({
...
VibeComplexRawMaterialSchema.plugin(mongoosePaginate);

module.exports = (connection) => connection.model('VibeComplexRawMaterial', VibeComplexRawMaterialSchema);
